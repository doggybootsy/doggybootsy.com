	...
	{#if devBanner}
		<div class={{
			...
			<div>
				{#if dev}
					Development Build
				{:else if isInDev && !page.url.host.endsWith(".workers.dev")}
		...
		<div class="flex gap-4 items-center">
			{#if dev}
				<Anchor 
					...
					role="button"
					class={{
						"focusOutline rounded-md p-3 text-red-500/80 hover:bg-red-700/25 hover:text-red-500 transition-colors": true,
						"bg-red-700/15": page.url.pathname.startsWith("/playground")
					}}
					no-default-class
				>
					<BugAnt />
